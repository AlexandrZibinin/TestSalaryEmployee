...
def main():
    parser = argparse.ArgumentParser(description='Обработка имен CSV-файлов с командной строки')
    parser.add_argument('files', nargs='+', help='Список имен CSV-файлов')
    parser.add_argument('--report', choices=REPORT_CHOICES, required=True, help='Тип отчета')
